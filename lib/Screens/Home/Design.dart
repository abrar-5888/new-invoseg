...
import 'package:testapp/Screens/Home/bloc/emergency_service_bloc.dart';
...
class HomeDesign1 extends StatefulWidget {
  static final routeName = "HomeDesign1";
                          ...
                          child: Padding(
                            ...
                            child: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  BlocListener<EmergencyServiceBloc,
                                      EmergencyServiceState>(
                                    listener: (context, state) {
                                      if (state is MedicalButtonPressedState) {
                                        alertme("button-two");
                                      } else if (state
                                          is GroceryButtonPressedState) {
                                        alertme("button-three");
                                      } else if (state
                                          is SecurityButtonPressedState) {
                                        alertme("button-one");
                                      } else if (state
                                          is OfflineButtonPressedState) {
                                                  ...
                                                  child: SizedBox(
                                                    ...
                                                    child: Container(
                                                      ...
                                                      child: TextButton.icon(
                                                        onPressed: () async {
                                                          BlocProvider.of<
                                                                      EmergencyServiceBloc>(
                                                                  context)
                                                              .add(
                                                                  MedicalButtonPressedEvent(
                                                                      1));
                                                          // if (button_count_med <=
                                                          //     25) {
                                                          //   setState(() {

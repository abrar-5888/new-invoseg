...
class _PendingState extends State<Pending> {
  ...
  Widget build(BuildContext context) {
    ...
    if (status == 'Pending' || status == 'pending' || status.isEmpty) {
      ...
      if (status.isEmpty) {
        setState(() {
          EmergencyOrders1 = [
            // {'DateTime': 'Dec 22, 2024 - 10:00 AM', 'Status': 'Link Generated'},
            {'DateTime': 'Dec 08, 2024 - 15:00 PM', 'Status': 'null'}
          ];
        });
      }
      ...
      return Scaffold(
        body: Center(
            child: Text(
          "No Pending Meetings Are Available",
